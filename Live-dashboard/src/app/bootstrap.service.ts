...
export class BootstrapService {
  ...
  private _initialize(): void {
    ...
    if (this._liveDashboardConfiguration.ks && this._liveDashboardConfiguration.host && this._liveDashboardConfiguration.entryId) {
      this._kalturaClient.ks = this._liveDashboardConfiguration.ks;
      this._kalturaClient.endpointUrl = this._liveDashboardConfiguration.host + environment.bootstrap.service_url_extension;
